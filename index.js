...
app.post("/api", (request, response) => {
    ...
    input = "I am a " + diff + " speaker in " + toLang + ". Can you help me generate 5 pairs of " + wordsOrSentences + " suitable for my level about " + topic + " and the " + fromLang + " translations? Please return only the JSON object and no other text, in this format: [{from: ..., to: ..., pronunication: ...}, {...}]."
