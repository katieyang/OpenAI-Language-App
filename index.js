...
function checkResult(resDict) {
    console.log(resDict)
    console.log(resDict['GPTresponse'])
    for (let item of resDict['GPTresponse']) {
...
app.post("/api", (request, response) => {
    ...
    response.json({
        status: "success",
        body: JSON.stringify({"fromArr":fromArr,"toArr":toArr,"pronunciationArr": pronunciationArr,"GPTresponse":GPTresponse})
    });
